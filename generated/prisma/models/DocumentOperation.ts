...
// @ts-nocheck 
/*
 * This file exports the `DocumentOperation` model and its related types.
 *
...
export type GetDocumentOperationAggregateType<T extends DocumentOperationAggregateArgs> = {
      [P in keyof T & keyof AggregateDocumentOperation]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDocumentOperation[P]>
    : Prisma.GetScalarType<T[P], AggregateDocumentOperation[P]>
}
...
export type GetDocumentOperationGroupByPayload<T extends DocumentOperationGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DocumentOperationGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DocumentOperationGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DocumentOperationGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DocumentOperationGroupByOutputType[P]>
      }
    >
  >
...
export type DocumentOperationWhereInput = {
  ...
  clientId?: Prisma.StringFilter<"DocumentOperation"> | string
  type?: Prisma.EnumOperationTypeFilter<"DocumentOperation"> | $Enums.OperationType
  payload?: Prisma.JsonFilter<"DocumentOperation">
  logicalClock?: Prisma.BigIntFilter<"DocumentOperation"> | bigint | number
  baseVersion?: Prisma.IntFilter<"DocumentOperation"> | number
...
export type DocumentOperationScalarWhereWithAggregatesInput = {
  ...
  clientId?: Prisma.StringWithAggregatesFilter<"DocumentOperation"> | string
  type?: Prisma.EnumOperationTypeWithAggregatesFilter<"DocumentOperation"> | $Enums.OperationType
  payload?: Prisma.JsonWithAggregatesFilter<"DocumentOperation">
  logicalClock?: Prisma.BigIntWithAggregatesFilter<"DocumentOperation"> | bigint | number
  baseVersion?: Prisma.IntWithAggregatesFilter<"DocumentOperation"> | number
...
export type DocumentOperationUpdateInput = {
  ...
  payload?: Prisma.JsonNullValueInput | runtime.InputJsonValue
  logicalClock?: Prisma.BigIntFieldUpdateOperationsInput | bigint | number
  baseVersion?: Prisma.IntFieldUpdateOperationsInput | number
...
export type DocumentOperationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "operationId" | "documentId" | "userId" | "clientId" | "type" | "payload" | "logicalClock" | "baseVersion" | "createdAt", ExtArgs["result"]["documentOperation"]>
...
export type DocumentOperationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<DocumentOperationFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DocumentOperationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['DocumentOperation'], meta: { name: 'DocumentOperation' } }
  /**
   ...
   * })
  **/
  count<T extends DocumentOperationCountArgs>(
    args?: Prisma.Subset<T, DocumentOperationCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DocumentOperationCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends DocumentOperationGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, DocumentOperationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDocumentOperationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface DocumentOperationFieldRefs {
  ...
  readonly type: Prisma.FieldRef<"DocumentOperation", 'OperationType'>
  readonly payload: Prisma.FieldRef<"DocumentOperation", 'Json'>
  readonly logicalClock: Prisma.FieldRef<"DocumentOperation", 'BigInt'>
  readonly baseVersion: Prisma.FieldRef<"DocumentOperation", 'Int'>
